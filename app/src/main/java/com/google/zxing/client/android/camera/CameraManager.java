...
public final class CameraManager {
	...
	public synchronized Rect getFramingRect() {
		if (framingRect == null) {
			...
			Log.d(TAG, "Calculated framing rect: " + framingRect.width()+"x"+framingRect.height());
		}
		return framingRect;
	}
	...
	public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data, int width, int height) {
		...
		Log.i(TAG, "buildLuminanceSource:" + width + "x" + height);
		Log.i(TAG, "buildLuminanceSource:" + rect);
		Log.i(TAG, "buildLuminanceSource:" + rect.width()+"x"+rect.height());
